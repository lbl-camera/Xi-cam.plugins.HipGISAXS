...
from . import customwidgets, display, featuremanager, ui
...
class HipGISAXSPlugin(GUIPlugin):
    name = 'HipGISAXS'
    ...
    def runDask(self):
        ...
        def hipgisaxs_func(yaml_str):
            ...
            a = subprocess.check_output(
                ["srun", "--job-name=hipgisaxs", "--nodes=1", "--ntasks=1", "--ntasks-per-node=1", "--time=00:30:00",
                 "/bin/bash", "/users/course79/rungisaxs.sh", filename])
            return a
